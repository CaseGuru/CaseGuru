import products from "./OrderdedProducts"
        ...
        <div className="max-w-2xl mx-auto pt-16 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          <div className="px-4 space-y-2 sm:px-0 sm:flex sm:items-baseline sm:justify-between sm:space-y-0">
            <div className="flex sm:items-baseline sm:space-x-4">
              <h1 className="text-2xl font-extrabold font-['Gilroy'] tracking-tight text-gray-900 sm:text-3xl">Order #54879</h1>
              <a href="#" className="hidden text-sm font-medium text-orange-600 hover:text-orange-500 sm:block font-['Gilroy']">
            ...
            <a href="#" className="text-sm font-medium text-orange-600 hover:text-orange-500 sm:hidden">
              View invoice<span aria-hidden="true"> &rarr;</span>
            </a>
          </div>
                  ...
                  <div className="border-t border-gray-200 py-6 px-4 sm:px-6 lg:p-8">
                    ...
                    <div className="mt-6" aria-hidden="true">
                      ...
                      <div className="hidden sm:grid grid-cols-4 text-sm font-medium text-gray-600 mt-6">
                        ...
                        <div className={classNames(product.step > 0 ? 'text-orange-600' : '', 'text-center')}>
                          Processing
                        </div>
                        <div className={classNames(product.step > 1 ? 'text-orange-600' : '', 'text-center')}>
                          Shipped
                        </div>
                        <div className={classNames(product.step > 2 ? 'text-orange-600' : '', 'text-right')}>
                          Delivered
                        </div>
                      </div>
                    </div>
            ...
            <div className="bg-gray-100 py-6 px-4 sm:px-6 sm:rounded-lg lg:px-8 lg:py-8 lg:grid lg:grid-cols-12 lg:gap-x-8">
              ...
              <dl className="mt-8 divide-y divide-gray-200 text-sm lg:mt-0 lg:col-span-5">
                ...
                <div className="pt-4 flex items-center justify-between">
                  ...
                  <dd className="font-medium text-orange-600">$83.16</dd>
                </div>
              </dl>
            </div>
          </div>
