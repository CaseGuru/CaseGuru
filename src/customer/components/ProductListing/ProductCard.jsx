  ...
  return (
    <div className="bg-white">
      <div className="max-w-2xl lg:py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="grid grid-cols-4 gap-x-4 gap-y-10 sm:gap-x-6 md:grid-cols-4 md:gap-y-0 lg:gap-x-8">
        {displayedProducts.map((product) => (
            ...
            >
              ...
              <div className="flex flex-row justify-center mt-4">
                <p className="text-center text-gray-500 mb-10 font-bold text-lg line-through mr-3 ">
                  ₹{product.price}
                </p>

                <p className=" text-center text-gray-900 mb-10 font-bold text-lg ">
                  ₹{product.discountedPrice}
                </p>
                <p className=" text-center text-green-500  mb-10 font-bold text-lg ml-2">
